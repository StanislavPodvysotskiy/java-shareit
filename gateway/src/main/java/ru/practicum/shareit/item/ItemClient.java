...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> save(ItemDto itemDto, Integer userId) {
    ...
    public ResponseEntity<Object> saveComment(CommentDto commentDto, Integer itemId, Integer userId) {
